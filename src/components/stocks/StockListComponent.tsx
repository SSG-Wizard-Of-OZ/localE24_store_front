                ...
                <div className="-mx-4 px-4">
                    <div className="min-w-full leading-normal">
                        ...
                        <div
                            ...
                            <div
                                className="col-span-1 h-full p-2 flex justify-center items-center">
                                <span>실 수량</span>
                            </div>
                        </div>
                        {/* table body */}
                        <div className="overflow-y-auto">
                            <div
                                ...
                                <div
                                    className="col-span-1 h-full p-2 flex justify-center items-center border-r border-gray-400 text-red-400">
                                    <span>10</span>
                                </div>
                                <div
                                    className="col-span-1 h-full p-1 flex justify-center items-center text-red-400">
                                    <span>8</span>
                                </div>
                            </div>
                        </div>
